...
def domain_split(dataset, model, device, cluster_before, filename, epoch, nmb_cluster=3, method='Kmeans', pca_dim=256, batchsize=16, num_workers=0, whitening=False, L2norm=False, instance_stat=True):
    cluster_method = Clustering(nmb_cluster, pca_dim, whitening, L2norm)
